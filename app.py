...
if st.button("🚀 통합 성과 분석 실행"):
    ...
    # [복원] 도전성 단계 설명
    st.info("💡 **도전성 단계 기준**: 최고목표가 과거 추세 대비 얼마나 도전적인지 나타냅니다. (150%↑: 한계혁신, 80~150%: 적극상향, 40~80%: 소극개선, 0~40%: 현상유지)")
