...
if st.button("🚀 모든 평가방법 통합 분석 실행"):
    ...
    <div style='background-color: #f9f9f9; padding: 15px; border-radius: 5px; border-left: 5px solid #d1d5db; margin-top: 10px;'>
        ...
        <div style='font-size: 0.88em; color: #555; margin-top: 8px; line-height: 1.8;'>
            ...
            • <span style='color: #777;'><b>2단계 (⚖️ 현상 유지)</b></span> : 도전성 지수 0% 이상 ~ 25% 미만<br>
            • <span style='color: #f0ad4e;'><b>3단계 (📈 소극 개선)</b></span> : 도전성 지수 25% 이상 ~ 50% 미만<br>
            • <span style='color: #0275d8;'><b>4단계 (🔥 적극 상향)</b></span> : 도전성 지수 50% 이상 ~ 100% 미만<br>
            • <span style='color: #5cb85c;'><b>5단계 (🏆 한계 혁신)</b></span> : 도전성 지수 100% 이상 (통계적 한계치 돌파 목표)
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    * **도전성 지수(zp)**: 최고목표와 과거 추세치($trend$)의 편차를 표준오차($S$)로 나눈 뒤 지수화한 값입니다.
