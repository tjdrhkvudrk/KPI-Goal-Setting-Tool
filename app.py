...
if st.button("🚀 시뮬레이션 및 분석 실행"):
    ...
    # 4. 도전적 목표 설정 가이드 (디자인 카드 렌더링 수정본)
    st.markdown("---")
    st.subheader("🎯 4. 도전적 목표 설정 가이드 (담당자 제언)")

    st.markdown("""
    <div style="background-color: #f8fafc; border-left: 5px solid #3182ce; padding: 15px; margin-bottom: 2
